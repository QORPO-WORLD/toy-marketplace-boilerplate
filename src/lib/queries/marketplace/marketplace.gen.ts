/* eslint-disable */
// marketplace-api  1763f767f86e9aebbe7995bc830ab1be49104d4b
// --
...
export const WebRPCSchemaHash = "1763f767f86e9aebbe7995bc830ab1be49104d4b";
...
export enum MarketplaceKind {
  unknown = "unknown",
  orderbook_v1 = "orderbook_v1",
  orderbook_v2 = "orderbook_v2",
  opensea = "opensea",
...
export interface ListCollectiblesWithLowestListingReturn {
  collectibles: Array<CollectibleListing>;
  page?: Page;
}
...
export interface ListCollectiblesWithHighestOfferReturn {
  collectibles: Array<CollectibleOffer>;
  page?: Page;
}
  ...
  listCollectiblesWithLowestListing = (
    ...
    return this.fetch(
      ...
      (res) => {
        return buildResponse(res).then((_data) => {
          return {
            collectibles: <Array<CollectibleListing>>_data.collectibles,
            page: <Page>_data.page,
          };
        });
      },
  ...
  listCollectiblesWithHighestOffer = (
    ...
    return this.fetch(
      ...
      (res) => {
        return buildResponse(res).then((_data) => {
          return {
            collectibles: <Array<CollectibleOffer>>_data.collectibles,
            page: <Page>_data.page,
          };
        });
      },
